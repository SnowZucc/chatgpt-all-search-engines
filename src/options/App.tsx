      ...
      <nav className="flex flex-row justify-between items-center mt-5 px-2">
        <div className="flex flex-row items-center gap-2">
          ...
          <span className="font-semibold">
            ChatGPT for Search Engines (v{getExtensionVersion()})
          </span>
        </div>
        <div className="flex flex-row gap-3">
          <a
            href="https://github.com/SnowZucc/chatgpt-all-search-engines/issues"
            target="_blank"
            rel="noreferrer"
          >
            Feedback
          ...
          <a
            href="https://github.com/SnowZucc/chatgpt-all-search-engines"
            target="_blank"
            rel="noreferrer"
          >
            Source code
